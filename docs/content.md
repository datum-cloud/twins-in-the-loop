...
| --- | --- | --- |
| `title` | Yes | Article H1, browser title, Open Graph title, RSS title, Web Share title |
| `description` | Yes | Meta description, Open Graph/Twitter description, RSS description |
...
| `embedUrl` | No | Optional video/podcast URL stored in frontmatter. Not rendered as an embed yet |
| SEO fields | See [SEO and sharing](./seo-and-sharing.md) | `canonical`, `og`, `noindex`, `keywords` |
